...
struct IGuestDirEntry_vtbl
{
    ...
    nsresult PR_COM_METHOD (*GetNodeId)(IGuestDirEntry *pThis, PRInt64 *nodeId);

    nsresult PR_COM_METHOD (*GetName)(IGuestDirEntry *pThis, PRUnichar * *name);

    nsresult PR_COM_METHOD (*GetType)(IGuestDirEntry *pThis, PRUint32 *type);
...
struct IGuest_vtbl
{
    ...
    nsresult PR_COM_METHOD (*CopyFromGuest)(
        IGuest *pThis,
        PRUnichar * source,
        PRUnichar * dest,
        PRUnichar * userName,
    ...
    nsresult PR_COM_METHOD (*DirectoryClose)(
        IGuest *pThis,
        PRUint32 handle
    );
    ...
    nsresult PR_COM_METHOD (*DirectoryRead)(
        IGuest *pThis,
        PRUint32 handle,
